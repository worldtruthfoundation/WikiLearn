...
// Additional exercise generation functions using OpenAI API
function generateGrammarExercises(articleTitle, englishLevel, outputContainer) {
    outputContainer.innerHTML = '<div class="loading"><div class="loading-spinner"></div>Generating grammar exercises...</div>';
    ...
    .then(data => {
        if (data.success) {
            outputContainer.innerHTML = formatAIResponse(data.exercise);
        } else {
            outputContainer.innerHTML = `<div class="error-message">Failed to generate grammar exercises: ${data.error}</div>`;
        }
    })
    .catch(error => {
        console.error('Error generating grammar exercises:', error);
        outputContainer.innerHTML = '<div class="error-message">Failed to generate grammar exercises. Please try again later.</div>';
    });
}

function generateVocabularyExercises(articleTitle, englishLevel, outputContainer) {
    outputContainer.innerHTML = '<div class="loading"><div class="loading-spinner"></div>Generating vocabulary exercises...</div>';
    ...
    .then(data => {
        if (data.success) {
            ...
            outputContainer.innerHTML = `<div class="error-message">Failed to generate vocabulary exercises: ${data.error}</div>`;
        }
    })
    .catch(error => {
        console.error('Error generating vocabulary exercises:', error);
        outputContainer.innerHTML = '<div class="error-message">Failed to generate vocabulary exercises. Please try again later.</div>';
    });
}

function generateExtraExercises(articleTitle, englishLevel, outputContainer) {
    outputContainer.innerHTML = '<div class="loading"><div class="loading-spinner"></div>Generating additional exercises...</div>';
    ...
    .then(data => {
        if (data.success) {
            ...
            outputContainer.innerHTML = `<div class="error-message">Failed to generate additional exercises: ${data.error}</div>`;
        }
    })
    .catch(error => {
        console.error('Error generating extra exercises:', error);
        outputContainer.innerHTML = '<div class="error-message">Failed to generate additional exercises. Please try again later.</div>';
    });
}
